$(function () {
    "use strict";
    var e = $(".datatable-project"), t = $(".datatable-invoice");
    e.length && e.DataTable({
        ...
        columnDefs: [{
            ...
            targets: 1, responsivePriority: 1, render: function (e, t, a, s) {
                var n = a.project_name, l = a.framework, r = a.project_image;
        ...
        columnDefs: [{
            ...
            targets: 2, render: function (e, t, a, s) {
                var n = a.invoice_status, l = a.due_date;
