    ...
    1: function (t, e) {
        ...
        (function (t, e) {
            !function (t, n) {
                "use strict";
                if (!t.setImmediate) {
                    var i, r, s, o, u, a = 1, c = {}, l = !1, h = t.document,
                    ...
                    }, t.addEventListener ? t.addEventListener("message", u, !1) : t.attachEvent("onmessage", u), i = function (e) {
                        t.postMessage(o + e, "*")
         ...
         */
            o = this, r = [n(1)], void 0 === (s = function (t) {
                return o.Bloodhound = (e = t, n = function () {
                    ...
                    return n.mixin(t.prototype, {
                        bootstrap: function (t) {
                            ...
                            t = n.isArray(t) ? t : [t], n.each(t, (function (t) {
                                var s, o;
                                e.datums[s = e.identify(t)] = t, o = i(e.datumTokenizer(t)), n.each(o, (function (t) {
                                    var n, i, o;
                    ...
                    function t(t) {
                        this.url = t.url, this.prepare = t.prepare, this.transform = t.transform, this.transport = new u({
                            cache: t.cache,
                            limiter: t.limiter,
                    ...
                    return function (i) {
                        ...
                        return r = {
                            ...
                            prefetch: null,
                            remote: null
                        }, !(i = n.mixin(r, i || {})).datumTokenizer && e.error("datumTokenizer is required"), !i.queryTokenizer && e.error("queryTokenizer is required"), s = i.sorter, i.sorter = s ? function (t) {
                            return t.sort(s)
                        } : n.identity, i.local = n.isFunction(i.local) ? i.local() : i.local, i.prefetch = function (i) {
                            var r;
                            return i ? (r = {
                                url: null,
                                ttl: 864e5,
                                ...
                                transport: null
                            }, i = n.isString(i) ? {url: i} : i, !(i = n.mixin(r, i)).url && e.error("prefetch requires url to be set"), i.transform = i.filter || i.transform, i.cacheKey = i.cacheKey || i.url, i.thumbprint = "0.11.1" + i.thumbprint, i.transport = i.transport ? t(i.transport) : e.ajax, i) : null
                        }(i.prefetch), i.remote = function (i) {
                            var r;
                            if (i) return r = {
                                url: null,
                                cache: !0,
                                ...
                                transform: n.identity,
                                transport: null
                            }, i = n.isString(i) ? {url: i} : i, !(i = n.mixin(r, i)).url && e.error("remote requires url to be set"), i.transform = i.filter || i.transform, i.prepare = function (t) {
                                var e, n, i;
                                return e = t.prepare, n = t.replace, i = t.wildcard, e || (e = n ? function (t, e) {
                                    return e.url = n(e.url, t), e
                                } : t.wildcard ? function (t, e) {
                                ...
                                var e, i, r;
                                return e = t.limiter, i = t.rateLimitBy, r = t.rateLimitWait, e || (e = /^throttle$/i.test(i) ? function (t) {
                                    return function (e) {
                    ...
                    function r(t) {
                        t = h(t), this.sorter = t.sorter, this.identify = t.identify, this.sufficient = t.sufficient, this.local = t.local, this.remote = t.remote ? new l(t.remote) : null, this.prefetch = t.prefetch ? new c(t.prefetch) : null, this.index = new a({
                    ...
                    return t = window && window.Bloodhound, r.noConflict = function () {
                ...
                return e = t, n = function () {
                    ...
                    return function (i) {
                        ...
                        return s = n.mixin({}, t, i), {
                            css: (r = {
                                ...
                                }, n.isMsie() && n.mixin(u.input, {backgroundImage: "url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)"}), u),
                                classes: s,
                                html: (o = s, {
                                ...
                                selectors: e(s)
                            }).css, html: r.html, classes: r.classes, selectors: r.selectors, mixin: function (t) {
                                n.mixin(t, r)
                            }
                        }
                    };
                    ...
                    "use strict";
                    var t = /\s+/, e = window.setImmediate ? function (t) {
                        i((function () {
                            t()
                        }))
                    } : function (t) {
                    ...
                    function r(t, r) {
                        ...
                        (t = t || {}).templates = t.templates || {}, t.templates.notFound = t.templates.notFound || t.templates.empty, t.source || e.error("missing source"), t.node || e.error("missing node"), t.name && (s = t.name, !/^[_a-zA-Z0-9-]+$/.test(s)) && e.error("invalid dataset name: " + t.name), r.mixin(this), this.highlight = !!t.highlight, this.name = t.name || i(), this.limit = t.limit || 5, this.displayFn = (o = (o = t.display || t.displayKey) || n.stringify, n.isFunction(o) ? o : function (t) {
                            ...
                            suggestion: u.suggestion || function (t) {
                                return e("<div>").text(a(t))
                            }
                        }), this.source = t.source.__ttAdapter ? t.source.__ttAdapter() : t.source, this.async = n.isUndefined(t.async) ? this.source.length > 2 : !!t.async, this._resetLastSuggestion(), this.$el = e(t.node).addClass(this.classes.dataset).addClass(this.classes.dataset + "-" + this.name)
                    }
                    ...
                    t = e.fn.typeahead, i = {www: "tt-www", attrs: "tt-attrs", typeahead: "tt-typeahead"}, o = {
                        initialize: function (t, o) {
                            ...
                            function g() {
                                ...
                                })), r = e(this), g = e(u.html.wrapper), m = p(t.hint), y = p(t.menu), v = !1 !== t.hint && !m, _ = !1 !== t.menu && !y, v && (m = c(r, u)), _ && (y = e(u.html.menu).css(u.css.menu)), m && m.val(""), r = d(r, u), (v || _) && (g.css(u.css.wrapper), r.css(v ? u.css.input : u.css.inputWithNoHint), r.wrap(g).parent().prepend(v ? m : null).append(_ ? y : null)), T = _ ? h : l, b = new s({el: r}), w = new a({
                                    hint: m,
                                    input: r
                                }, u), S = new T({node: y, datasets: o}, u), x = new f({
                                    input: w,
                                    menu: S,
                                    eventBus: b,
                                    minLength: t.minLength
                                }, u), r.data(i.www, u), r.data(i.typeahead, x)
                            }
                        }, isEnabled: function () {
                            var t;
                            ...
                            return u(this, (function (t, e) {
                                !function (t) {
                                    var e, r;
                                    e = t.data(i.www), r = t.parent().filter(e.selectors.wrapper), n.each(t.data(i.attrs), (function (e, i) {
                                        n.isUndefined(e) ? t.removeAttr(i) : t.attr(i, e)
                                    })), t.removeData(i.typeahead).removeData(i.www).removeData(i.attr).removeClass(e.classes.input), r.length && (t.detach().insertAfter(r), r.remove())
                                }(e), t.destroy()
                            })), this
                        }
