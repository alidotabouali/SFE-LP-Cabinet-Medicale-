                    ...
                    n && n.requirejs || (n ? t = n : n = {}, function (n) {
                        ...
                        s = function (e, t) {
                            ...
                            if (f = b(i = i || e), "undefined" === $ || "function" === $) {
                                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, h = 0; h < t.length; h += 1) if ("require" === (o = (p = s(t[h], f)).f)) w[h] = a.require(e); else if ("exports" === o) w[h] = a.exports(e), m = !0; else if ("module" === o) r = w[h] = a.module(e); else if (g(l, o) || g(c, o) || g(d, o)) w[h] = _(o); else {
