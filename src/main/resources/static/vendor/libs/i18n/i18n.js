    ...
    191: function (e, t) {
        ...
        var O = {
            ...
            return u(e, [{
                ...
                key: "forward", value: function (e, t, n, o) {
        ...
        var D = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1,
            H = function (e) {
                ...
                return d(t, e), u(t, [{
                    ...
                    key: "addResourceBundle", value: function (e, t, n, o, r) {
                ...
                return d(t, e), u(t, [{
                    ...
                    key: "translate", value: function (e, t) {
                        ...
                        var r = void 0 !== t.keySeparator ? t.keySeparator : this.options.keySeparator,
                            a = this.extractFromKey(e[e.length - 1], t), s = a.key, u = a.namespaces, l = u[u.length - 1],
                        ...
                        var g = this.resolve(e, t), h = g && g.res, d = g && g.usedKey || s, v = g && g.exactUsedKey || s,
                        ...
                        if (k && h && x && m.indexOf(y) < 0 && ("string" != typeof b || "[object Array]" !== y)) {
                            ...
                            if (r) {
                                var w = "[object Array]" === y, S = w ? [] : {}, O = w ? v : d;
                                for (var L in h) if (Object.prototype.hasOwnProperty.call(h, L)) {
                                    var P = "".concat(O).concat(r).concat(L);
                                    S[L] = this.translate(P, i({}, t, {joinArrays: !1, ns: u})), S[L] === P && (S[L] = h[L])
                                }
                                h = S
                            }
                        } else if (k && "string" == typeof b && "[object Array]" === y) (h = h.join(b)) && (h = this.extendTranslation(h, e, t)); else {
                            var R = !1, j = !1;
                            ...
                            if (j || R || N) {
                                ...
                                if ("fallback" === this.options.saveMissingTo && F && F[0]) for (var T = 0; T < F.length; T++) E.push(F[T]); else "all" === this.options.saveMissingTo ? E = this.languageUtils.toResolveHierarchy(t.lng || this.language) : E.push(t.lng || this.language);
                                var A = function (e, o) {
        ...
        var B = function () {
            ...
            return u(e, [{
                ...
                key: "toResolveHierarchy", value: function (e, t) {
                    var n = this, o = this.getFallbackCodes(t || this.options.fallbackLng || [], e), r = [],
                        i = function (e) {
        ...
        var X = function () {
            ...
            return u(e, [{
                ...
                key: "getSuffix", value: function (e, t) {
                    var n = this, o = this.getRule(e);
                    if (o) {
                        var r = o.noAbs ? o.plurals(t) : o.plurals(Math.abs(t)), i = o.numbers[r];
            ...
            return u(e, [{
                ...
                key: "interpolate", value: function (e, t, n, o) {
                    ...
                    var c = function (e) {
                        ...
                        var i = e.split(s.formatSeparator), a = i.shift().trim(), l = i.join(s.formatSeparator).trim();
                    ...
                    for (a = 0; r = this.regexpUnescape.exec(e);) {
                        if (void 0 === (i = c(r[1].trim()))) if ("function" == typeof f) {
                            var p = f(e, r, o);
                            i = "string" == typeof p ? p : ""
                        } else this.logger.warn("missed to pass in variable ".concat(r[1], " for interpolating ").concat(e)), i = ""; else "string" == typeof i || this.useRawValueToEscape || (i = j(i));
                ...
                key: "nest", value: function (e, t) {
                    ...
                    function u(e, t) {
                        ...
                        var o = e.split(new RegExp("".concat(n, "[ ]*{"))), r = "{".concat(o[1]);
        ...
        var G = function (e) {
            ...
            return d(t, e), u(t, [{
                key: "queueLoad", value: function (e, t, n, o) {
                    var r = this, i = [], a = [], s = [], u = [];
                    return e.forEach((function (e) {
                        var o = !0;
                ...
                key: "loaded", value: function (e, t, n) {
                    var o = S(e.split("|"), 2), r = o[0], i = o[1];
                    t && this.emit("failedLoading", r, i, t), n && this.store.addResourceBundle(r, i, n), this.state[e] = t ? -1 : 2;
                    var a = {};
                    this.queue.forEach((function (n) {
                        var o, s, u, l, c, f;
                        o = n.loaded, s = i, l = N(o, [r], Object), c = l.obj, f = l.k, c[f] = c[f] || [], u && (c[f] = c[f].concat(s)), u || c[f].push(s), function (e, t) {
            ...
            return d(t, e), u(t, [{
                key: "init", value: function () {
                    ...
                    if ("function" == typeof t && (n = t, t = {}), this.options = i({}, Y(), this.options, Q(t)), this.format = this.options.interpolation.format, n || (n = Z), !this.options.isClone) {
                        ...
                        }), a.interpolator = new J(this.options), a.utils = {hasLoadedNamespace: this.hasLoadedNamespace.bind(this)}, a.backendConnector = new G(o(this.modules.backend), a.resourceStore, a, this.options), a.backendConnector.on("*", (function (t) {
                ...
                key: "loadResources", value: function (e) {
                    var t = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Z, o = n,
                ...
                key: "hasLoadedNamespace", value: function (e) {
                    ...
                    var n = this.languages[0], o = !!this.options && this.options.fallbackLng,
                ...
                key: "loadLanguages", value: function (e, t) {
                    var n = R();
                    "string" == typeof e && (e = [e]);
                    var o = this.options.preload || [], r = e.filter((function (e) {
                ...
                key: "cloneInstance", value: function () {
                    var e = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        r = i({}, this.options, n, {isClone: !0}), a = new t(r), s = ["store", "services", "language"];
                    return s.forEach((function (t) {
                        a[t] = e[t]
                    })), a.services = i({}, this.services), a.services.utils = {hasLoadedNamespace: a.hasLoadedNamespace.bind(a)}, a.translator = new q(a.services, a.options), a.translator.on("*", (function (e) {
                        for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) n[o - 1] = arguments[o];
        ...
        }(P)), te = [], ne = te.forEach, oe = te.slice;
        ...
        var ue = function () {
            ...
            return u(e, [{
                ...
                key: "create", value: function (e, t, n, o) {
                    var r = this;
                    "string" == typeof e && (e = [e]);
        ...
        ue.type = "backend";
        var le = ue, ce = [], fe = ce.forEach, pe = ce.slice;
