!function (t, e) {
    ...
    1: function (t, e) {
         ...
         */
        r = [n(1), n(2)], void 0 === (i = function (t) {
            return function (t, e, n, r) {
                "use strict";
                var i = t.fn.dataTable, s = function (e, n) {
                    if (!i.versionCheck || !i.versionCheck("1.10.10")) throw"DataTables Responsive requires DataTables 1.10.10 or newer";
                    this.s = {
                        dt: new i.Api(e),
                        columns: [],
                        current: []
                    }, this.s.dt.settings()[0].responsive || (n && "string" == typeof n.details ? n.details = {type: n.details} : n && !1 === n.details ? n.details = {type: !1} : n && !0 === n.details && (n.details = {type: "inline"}), this.c = t.extend(!0, {}, s.defaults, i.defaults.responsive, n), e.responsive = this, this._constructor())
                };
                t.extend(s.prototype, {
                    _constructor: function () {
                        var n = this, r = this.s.dt, s = r.settings()[0], o = t(e).innerWidth();
                        r.settings()[0]._responsive = this, t(e).on("resize.dtr orientationchange.dtr", i.util.throttle((function () {
                            var r = t(e).innerWidth();
                            r !== o && (n._resize(), o = r)
                        }))), s.oApi._fnCallbackReg(s, "aoRowCreatedCallback", (function (e, i, s) {
                        ...
                        !1 !== a.type && (n._detailsInit(), r.on("column-visibility.dtr", (function () {
                            ...
                            n._redrawChildren()
                        })), t(r.table().node()).addClass("dtr-" + a.type)), r.on("column-reorder.dtr", (function (t, e, r) {
                        ...
                        var n, r, i = this.s.dt, s = this.s.columns, o = s.map((function (t, e) {
                        ...
                        for (n = 0, r = a.length; n < r; n++) !0 === a[n] && (d += s[n].minWidth);
                        var l = i.settings()[0].oScroll, c = l.sY || l.sX ? l.iBarWidth : 0,
                            u = i.table().container().offsetWidth - c - d;
                        for (n = 0, r = a.length; n < r; n++) s[n].control && (u -= s[n].minWidth);
                        var p = !1;
                        for (n = 0, r = o.length; n < r; n++) {
                            var f = o[n].columnIdx;
                            "-" === a[f] && !s[f].control && s[f].minWidth && (p || u - s[f].minWidth < 0 ? (p = !0, a[f] = !1) : a[f] = !0, u -= s[f].minWidth)
                        }
                        var h = !1;
                        for (n = 0, r = s.length; n < r; n++) if (!s[n].control && !s[n].never && !1 === a[n]) {
                            h = !0;
                            break
                        }
                        for (n = 0, r = s.length; n < r; n++) s[n].control && (a[n] = h), "not-visible" === a[n] && (a[n] = !1);
                        return -1 === t.inArray(!0, a) && (a[0] = !0), a
                    }, _classLogic: function () {
                        var e = this, n = this.c.breakpoints, i = this.s.dt, s = i.columns().eq(0).map((function (t) {
                            var e = this.column(t), n = e.header().className,
                                s = i.settings()[0].aoColumns[t].responsivePriority,
                                o = e.header().getAttribute("data-priority");
                            return s === r && (s = o === r || null === o ? 1e4 : 1 * o), {
                                className: n,
                                includeIn: [],
                                auto: !1,
                                control: !1,
                            ...
                            var d, l, c;
                            if (i) {
                                if ("max-" === i) for (d = e._find(r).width, l = 0, c = n.length; l < c; l++) n[l].width <= d && o(t, n[l].name); else if ("min-" === i) for (d = e._find(r).width, l = 0, c = n.length; l < c; l++) n[l].width >= d && o(t, n[l].name); else if ("not-" === i) for (l = 0, c = n.length; l < c; l++) -1 === n[l].name.indexOf(a) && o(t, n[l].name)
                            } else s[t].includeIn.push(r)
                        };
                        s.each((function (e, r) {
                            for (var i = e.className.split(" "), s = !1, o = 0, d = i.length; o < d; o++) {
                                var l = i[o].trim();
                                if ("all" === l) return s = !0, void (e.includeIn = t.map(n, (function (t) {
                                    return t.name
                                })));
                                if ("none" === l || e.never) return void (s = !0);
                                if ("control" === l || "dtr-control" === l) return s = !0, void (e.control = !0);
                                t.each(n, (function (t, e) {
                                    var n = e.name.split("-"),
                                        i = new RegExp("(min\\-|max\\-|not\\-)?(" + n[0] + ")(\\-[_a-zA-Z0-9])?"),
                                        o = l.match(i);
                                    o && (s = !0, o[2] === n[0] && o[3] === "-" + n[1] ? a(r, e.name, o[1], o[2] + o[3]) : o[2] !== n[0] || o[3] || a(r, e.name, o[1], o[2]))
                                }))
                            }
                            s || (e.auto = !0)
                        })), this.s.columns = s
                        ...
                        var r = this, i = this.s.dt, s = this.c.details;
                        if (s && !1 !== s.type) {
                            var o = s.display(e, n, (function () {
                                return s.renderer(i, e[0], r._detailsObj(e[0]))
                            }));
                        ...
                        var s = i.target, o = "string" == typeof s ? s : "td, th";
                        s === r && null === s || t(n.table().body()).on("click.dtr mousedown.dtr mouseup.dtr", o, (function (r) {
                        ...
                        return t.map(this.s.columns, (function (i, s) {
                            if (!i.never && !i.control) {
                                var o = r.settings()[0].aoColumns[s];
                                return {
                                    className: o.sClass,
                                    columnIndex: s,
                                    data: r.cell(e, s).render(n.c.orthogonal),
                                    hidden: r.column(s).visible() && !n.s.current[s],
                                    rowIndex: e,
                                    title: null !== o.sTitle ? o.sTitle : t(r.column(s).header()).text()
                                }
                            }
                        }))
                    }, _find: function (t) {
                        ...
                        var r, i, s = this, o = this.s.dt, a = t(e).innerWidth(), d = this.c.breakpoints, l = d[0].name,
                            c = this.s.columns, u = this.s.current.slice();
                        for (r = d.length - 1; r >= 0; r--) if (a <= d[r].width) {
                            l = d[r].name;
                            break
                        }
                        ...
                        this.s.current = p;
                        var f = !1;
                        for (r = 0, i = c.length; r < i; r++) if (!1 === p[r] && !c[r].never && !c[r].control && 0 == !o.column(r).visible()) {
                            f = !0;
                            break
                        }
                        ...
                        o.columns().eq(0).each((function (t, e) {
                            !0 === p[e] && m++, (n || p[e] !== u[e]) && (h = !0, s._setColumnVis(t, p[e]))
                        })), h && (this._redrawChildren(), t(o.table().node()).trigger("responsive-resize.dt", [o, this.s.current]), 0 === o.page.info().recordsDisplay && t("td", o.table().body()).eq(0).attr("colspan", m)), s._controlClass()
                        ...
                        if (this.c.auto && -1 !== t.inArray(!0, t.map(n, (function (t) {
                            ...
                            var r = e.table().node().cloneNode(!1), i = t(e.table().header().cloneNode(!1)).appendTo(r),
                                s = t(e.table().body()).clone(!1, !1).empty().appendTo(r);
                            r.style.width = "auto";
                            var d = e.columns().header().filter((function (t) {
                            ...
                            if (l) {
                                var c = t(l.cloneNode(!1)).appendTo(r), u = e.columns().footer().filter((function (t) {
                                    return e.column(t).visible()
                                })).to$().clone(!1).css("display", "table-cell");
                                t("<tr/>").append(u).appendTo(c)
                            }
                            t("<tr/>").append(d).appendTo(i), "inline" === this.c.details.type && t(r).addClass("dtr-inline collapsed"), t(r).find("[name]").removeAttr("name"), t(r).css("position", "relative");
                            var p = t("<div/>").css({width: 1, height: 1, overflow: "hidden", clear: "both"}).append(r);
                            p.insertBefore(e.table().node()), d.each((function (t) {
                ...
                }), s.breakpoints = [{name: "desktop", width: 1 / 0}, {
                    name: "tablet-l",
                    width: 1024
                    ...
                    childRow: function (e, n, r) {
                        ...
                        return function (r, i, s) {
                            if (i) t("div.dtr-modal-content").empty().append(s()); else {
                                var o = function () {
                ...
                function a(t, e, n) {
                    var i = e + "-" + n;
                    if (o[i]) {
                        for (var s = t.cell(e, n).node(), a = o[i][0].parentNode.childNodes, d = [], l = 0, c = a.length; l < c; l++) d.push(a[l]);
                ...
                s.renderer = {
                    listHiddenNodes: function () {
                        return function (e, n, r) {
                            var i = t('<ul data-dtr-index="' + n + '" class="dtr-details"/>'), s = !1;
                            return t.each(r, (function (n, r) {
                                if (r.hidden) {
                                    var a = r.className ? 'class="' + r.className + '"' : "";
                                    t("<li " + a + ' data-dtr-index="' + r.columnIndex + '" data-dt-row="' + r.rowIndex + '" data-dt-column="' + r.columnIndex + '"><span class="dtr-title">' + r.title + "</span> </li>").append(t('<span class="dtr-data"/>').append(function (t, e, n) {
                                        var r = e + "-" + n;
                                        if (o[r]) return o[r];
                                        for (var i = [], s = t.cell(e, n).node().childNodes, a = 0, d = s.length; a < d; a++) i.push(s[a]);
                                        return o[r] = i, i
                                    }(e, r.rowIndex, r.columnIndex))).appendTo(i), s = !0
                                }
                            })), !!s && i
                        }
                    }, listHidden: function () {
                        ...
                        return e = t.extend({tableClass: ""}, e), function (n, r, i) {
                            ...
                            return t('<table class="' + e.tableClass + ' dtr-details" width="100%"/>').append(s)
                        }
                    }
                }, s.defaults = {
                ...
                })), s.version = "2.2.9", t.fn.dataTable.Responsive = s, t.fn.DataTable.Responsive = s, t(n).on("preInit.dt.dtr", (function (e, n, r) {
