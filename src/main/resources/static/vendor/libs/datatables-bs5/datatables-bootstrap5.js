        ...
        a = [r(1), r(2)], void 0 === (n = function (e) {
            return function (e, t, r, a) {
                ...
                return e.extend(!0, n.defaults, {
                    ...
                    var c, u, f, p = new n.Api(t), b = t.oClasses, g = t.oLanguage.oPaginate,
                        m = t.oLanguage.oAria.paginate || {}, x = 0, v = function (r, a) {
                            ...
                            for (n = 0, o = a.length; n < o; n++) if (f = a[n], Array.isArray(f)) v(r, f); else {
                                switch (c = "", u = "", f) {
                                    case"ellipsis":
                                        c = "&#x2026;", u = "disabled";
                                        break;
                                ...
                                c && (s = e("<li>", {
                                    ...
                                    class: "page-link"
                                }).html(c)).appendTo(r), t.oApi._fnBindAction(s, {action: f}, y), x++)
                            }
                        };
                    try {
