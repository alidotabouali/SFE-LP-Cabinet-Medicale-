!function (t, e) {
    ...
    263: function (t, e, n) {
        ...
        !function (r, s, o, a) {
            "use strict";
            var u, h = ["", "webkit", "Moz", "MS", "ms", "o"], c = s.createElement("div"), l = Math.round, p = Math.abs,
                f = Date.now;
            ...
            function m(t, e, n) {
                var i;
                if (t) if (t.forEach) t.forEach(e, n); else if (void 0 !== t.length) for (i = 0; i < t.length;) e.call(n, t[i], i, t), i++; else for (i in t) t.hasOwnProperty(i) && e.call(n, t[i], i, t)
            }
            ...
            var y = g((function (t, e, n) {
                ...
                return t
            }), "extend", "Use `assign`."), T = g((function (t, e) {
                return y(t, e, !0)
            }), "merge", "Use `assign`.");
            ...
            var N = "ontouchstart" in r, X = void 0 !== M(r, "PointerEvent"),
                Y = N && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), F = ["x", "y"],
                W = ["clientX", "clientY"];
            ...
            function j(t, e, n) {
                var i = n.pointers.length, r = n.changedPointers.length, s = 1 & e && i - r == 0,
                    o = 12 & e && i - r == 0;
                n.isFirst = !!s, n.isFinal = !!o, s && (t.session = {}), n.eventType = e, function (t, e) {
                    ...
                    var s = n.firstInput, o = n.firstMultiple, a = o ? o.center : s.center, u = e.center = L(i);
                    e.timeStamp = f(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = G(a, u), e.distance = V(a, u), function (t, e) {
                    ...
                    e.overallVelocityX = h.x, e.overallVelocityY = h.y, e.overallVelocity = p(h.x) > p(h.y) ? h.x : h.y, e.scale = o ? (c = o.pointers, l = i, V(l[0], l[1], W) / V(c[0], c[1], W)) : 1, e.rotation = o ? function (t, e) {
                        return G(e[1], e[0], W) + G(t[1], t[0], W)
                    }(o.pointers, i) : 0, e.maxPointers = n.prevInput ? e.pointers.length > n.prevInput.maxPointers ? e.pointers.length : n.prevInput.maxPointers : e.pointers.length, function (t, e) {
                        var n, i, r, s, o = t.lastInterval || e, a = e.timeStamp - o.timeStamp;
                        if (8 != e.eventType && (a > 25 || void 0 === o.velocity)) {
                            var u = e.deltaX - o.deltaX, h = e.deltaY - o.deltaY, c = H(a, u, h);
            ...
            r.MSPointerEvent && !r.PointerEvent && (K = "MSPointerDown", Q = "MSPointerMove MSPointerUp MSPointerCancel"), E(tt, q, {
                handler: function (t) {
                    var e = this.store, n = !1, i = t.type.toLowerCase().replace("ms", ""), r = $[i],
                        s = J[t.pointerType] || t.pointerType, o = "touch" == s, a = D(e, t.pointerId, "pointerId");
            ...
            function it(t, e) {
                var n = O(t.touches), i = O(t.changedTouches);
            ...
            function ot(t, e) {
                var n = O(t.touches), i = this.targetIds;
                if (3 & e && 1 === n.length) return i[n[0].identifier] = !0, [n, n];
                var r, s, o = O(t.changedTouches), a = [], u = this.target;
                if (s = n.filter((function (t) {
                    return P(t.target, u)
                })), 1 === e) for (r = 0; r < s.length;) i[s[r].identifier] = !0, r++;
            ...
            var lt = M(c.style, "touchAction"), pt = void 0 !== lt, ft = function () {
                if (!pt) return !1;
            ...
            dt.prototype = {
                set: function (t) {
                    ...
                    if (this.manager.session.prevented) e.preventDefault(); else {
                        var i = this.actions, r = x(i, "none") && !ft.none, s = x(i, "pan-y") && !ft["pan-y"],
            ...
            vt.prototype = {
                ...
                process: function (t) {
                    ...
                    if (this._input = t, !i || !n || 12 & t.eventType && !r) this.reset(); else if (1 & t.eventType) this.reset(), this._timer = d((function () {
            ...
            }), Pt.VERSION = "2.0.7", Pt.defaults = {
                domEvents: !1,
                touchAction: "compute",
                enable: !0,
                inputTarget: null,
                inputClass: null,
                preset: [[_t, {enable: !1}], [bt, {enable: !1}, ["rotate"]], [At, {direction: 6}], [Et, {direction: 6}, ["swipe"]], [St], [St, {
                    event: "doubletap",
                    taps: 2
                }, ["tap"]], [It]],
                cssProps: {
            ...
            function xt(t, e) {
                var n;
                this.options = u({}, Pt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new ((n = this).options.inputClass || (X ? tt : Y ? st : N ? at : B))(n, j), this.touchAction = new dt(this, this.options.touchAction), Ct(this, !0), m(this.options.recognizers, (function (t) {
            ...
            xt.prototype = {
                set: function (t) {
                    ...
                    if (t = this.get(t)) {
                        var e = this.recognizers, n = D(e, t);
                ...
                bindFn: b,
                prefixed: M
            }), (void 0 !== r ? r : "undefined" != typeof self ? self : {}).Hammer = Pt, void 0 === (i = function () {
                return Pt
